...
export default function Shipping() {
  ...
  async function getProduct() {
      let result = await fetch("http://127.0.0.1:8000/api/getordershipping");
  ...
  async function giaoHang(id){
   ...
   console.log(order_id.value);
    ...
    let result = await fetch("http://127.0.0.1:8000/api/vanchuyen/"+ id, {
        method: "post",
        body: formData,
    });
    result = await result.json();
      ...
      <div className="container-fluid">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h4 className="m-0"><b>Danh Sách Order đang vận chuyển tới khách </b></h4>
          </div>{/* /.col */}
          <div className="col-sm-6">
           ...
           {product.name}
            ...
            <td className="project-actions text-right">
              ...
              <Form.Control type="hidden" id="order_id" defaultValue={product.id} />
                ...
                <a className="btn btn-success btn-s" onClick={()=>giaoHang(product.product_id)}>
