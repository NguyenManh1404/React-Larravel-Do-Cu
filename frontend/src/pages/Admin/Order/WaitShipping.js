...
export default function WaitShipping() {
  ...
  async function getProduct() {
      let result = await fetch("http://127.0.0.1:8000/api/getorderwaitshipping");
  ...
  async function xuatKho(id){
   ...
   console.log(order_id.value);
    ...
    let result = await fetch("http://127.0.0.1:8000/api/xuatkho/"+ id, {
        method: "post",
        body: formData,
    });
    result = await result.json();
      ...
      <div className="container-fluid">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h4 className="m-0"><b>Danh Sách Order Chờ Xuất Kho</b></h4>
          </div>{/* /.col */}
          <div className="col-sm-6">
           ...
           {product.name}
            ...
            <td className="project-actions text-right">
              ...
              <Form.Control type="hidden" id="order_id" defaultValue={product.id} />
                ...
                <a className="btn btn-success btn-s" onClick={()=>xuatKho(product.product_id)}>
